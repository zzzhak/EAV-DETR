...
# For compatibility with old torchvision versions
try:
    from torchvision import datapoints
except ImportError:
    # Define a dummy class if datapoints is not available
    class _Datapoints:
...
class ConvertCocoPolysToMask(object):
    ...
    def __call__(self, image, target):
        ...
        # Keep original box format - will be 4D for COCO, 5D for oriented datasets
