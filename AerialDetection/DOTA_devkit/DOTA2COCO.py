...
# DOTA dataset classes (15 classes)
wordname_15 = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
               'basketball-court', 'storage-tank',  'soccer-ball-field', 'roundabout', 'harbor', 'swimming-pool', 'helicopter']

# DOTA dataset classes (16 classes)
...
# CODrone dataset classes (12 classes)
codrone_classes = ['car', 'truck', 'traffic-sign', 'people', 'motor', 'bicycle',
                   'traffic-light', 'tricycle', 'bridge', 'bus', 'boat', 'ship']

def DOTA2COCOTrain(srcpath, destfile, cls_names, difficult='2', img_ext='.png'):
...
def DOTA2COCOTest(srcpath, destfile, cls_names, img_ext='.png'):
    imageparent = os.path.join(srcpath, 'images')
    data_dict = {}
